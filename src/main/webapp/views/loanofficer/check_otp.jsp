				...
				<div class=" card shadow-5-strong" style="padding: 10px;">
					<div class="team-6">
						...
						<div class="team-content">
							...
							<br>
							<button type="button" class="btn btn-primary">Bank Manager Login</button>
					...
					<div class="team-6">
						...
						<div class="team-content">
							...
							<button type="button" class="btn btn-primary"
								data-mdb-toggle="modal" data-mdb-target="#x" id="btn"
								onclick="test()">LoanOfficer Login</button>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel1">Loan
												Officer Login</h5>
											<a href="/mainhome"><button type="button"
													class="btn-close" data-mdb-dismiss="modal"
													aria-label="Close"></button></a>
										</div>
										<div class="modal-body">
											<h3>Otp Verification</h3>
											<h6>OTP has been sent to your Registered Mobile Number
												${smsRequest.getPhoneNumber()}</h6>
											<form align='center' action="/sms2/verifyOTP" method="POST">
												<input type="hidden" id="otp" name="otp" value="${otp}">
												<input type="hidden" id="phoneNumber" name="phoneNumber"
													value="${smsRequest.getPhoneNumber()}">
												<div class="row">
													<div class="col-md-8 align-self-center">
														<input type="text" id="user_otp" name="user_otp"
															class="form-control" Placeholder="Enter 6 - digits OTP">
													</div>
											...
											<br>
											<form align='center' action="/sms2/resendOTP" method="POST">
												<input type="hidden" id="phoneNumber" name="phoneNumber"
													value="${smsRequest.getPhoneNumber()}">
												<div class="row">
													<div class="col-md-6 align-self-center"
														style="text-align: right">Didn't Get OTP ? Click
														Here to</div>
													<div class="col-md-6 align-self-center"
														style="align: right">
														<button type="submit" value="Resend"
															class="btn btn-link px-3 me-5">Resend OTP</button>
													</div>
										...
										<div class="modal-footer">
											<a href="/mainhome"><button type="button"
													class="btn btn-secondary" data-mdb-dismiss="modal">
													Close</button></a>
					...
					<div class="team-6">
						...
						<div class="team-content">
							...
							<br> <a href=""><button type="button"
									class="btn btn-primary">Customer Login</button></a>
						</div>
					</div>
				</div>
			</div>
