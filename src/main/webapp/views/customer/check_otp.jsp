				...
				<div class=" card shadow-5-strong" style="padding: 10px;">
					<div class="team-6">
						...
						<div class="team-content">
							...
							<br>
							<button type="button" class="btn btn-primary" >Bank
				...
				<div class=" card shadow-5-strong" style="padding: 10px;">
					<div class="team-6">
						...
						<div class="team-content">
							...
							<button type="button" class="btn btn-primary" >LoanOfficer Login</button>
...
<button type="button" class="btn btn-primary"
								...
								onclick="test()">Customer Login</button>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel2">Customer
												 Login</h5>
										...
										<div class="modal-body">
											...
											<form align='center' action="/sms3/verifyOTP" method="POST">
											...
											<br>
											<form align='center' action="/sms3/resendOTP" method="POST">
												<input type="hidden" id="phoneNumber" name="phoneNumber"
													value="${smsRequest.getPhoneNumber()}">
												<div class="row">
