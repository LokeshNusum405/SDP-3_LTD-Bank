...
<body>
	...
	<div class="section-title">
		<h1>Verified Loan Application</h1>
	</div>
	...
	<div class="container	">
		<div class="modal-header">
			...
			Check Your Details Carefully and Proceed Further
		...
		<div class="modal-body">
			<span>${msg }</span>
				...
				<div class="modal-header">
					<h5 class="modal-title">
						<i class="fas fa-user pe-3"></i>Other Details
					</h5>
				...
				<div class="row col-md">
					...
					<div class="row col-md-6">
						<div class="col-md-4 align-self-center">
							<label for="phoneNumber">Issued by</label>
						</div>
						<div class="col-md-8 align-self-center" >
							<input type="text" class="form-control" id="issuedbyloname"
								name="issuedbyloname"
								Placeholder="Enter "
								value="${loan.issuedbyloname }" readonly>
						</div>
					</div>
					<div class="row col-md-6">
						<div class="col-md-4 align-self-center">
							<label for="phoneNumber">Verified on</label>
						</div>
						<div class="col-md-8 align-self-center">
							<input type="text" class="form-control" id="issuedon"
								name="issuedon"
								Placeholder="Enter Requested Loan Ammount"
								value="${loan.issuedon }" readonly>
						</div>
					</div>
				</div>
				<br>
				<div class="row col-md">
					...
					<div class="row col-md-6">
						<div class="col-md-4 align-self-center">
							<label for="phoneNumber">Applied on</label>
						</div>
						<div class="col-md-8 align-self-center">
							<input type="text" class="form-control" id="appliedon"
								name="appliedon" Placeholder="Enter Loan Collaterals"
								value="${loan.appliedon }" readonly>
						</div>
					</div>
					<div class="row col-md-6">
						<div class="col-md-4 align-self-center">
							<label for="phoneNumber">Loan Status</label>
						</div>
						<div class="col-md-8 align-self-center">
							<input type="text" class="form-control" id="loanstatus"
								name="loanstatus" Placeholder="Enter Loan Collaterals"
								value="${loan.loanstatus }" readonly>
						</div>
					</div>
					
				</div>
				<br>
				<form  method="post"action="/loanaccepted"
				 name="myForm" align="center">
				<div class="row col-md">
						<div class="col-md-4 align-self-center">
							<label for="phoneNumber">Enter Amount to be Sanction </label>
						</div>
						<div class="col-md-4 align-self-center">
							<input type="number" step="0.01" class="form-control" id="loanamount"
								value="${loan.loanamount}" name="loanamount"
				...
				<div>
					<p style="color:red">*I thorouglly verified the all loan details and identity proofs submited by customer  and the loan ammount is approved based on the All Documents </p>
				</div>
				<div>
				...
				<input type="submit" class="btn btn-primary" value="Accept">
					...
					<a href="/loanrejected" class="btn btn-danger">Reject</a>
			</form>
		</div>
